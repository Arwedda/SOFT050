    ...
    Sub DrawCards()
        If iRound = 0 Then
            Do While sPCard(0) = sPCard(1) or sPCard(0) = sC1Card(0) or sPCard(0) = sC1Card(1) or sPCard(1) = sC1Card(0) or sPCard(1) = sC1Card(1) or sC1Card(0) = sC1Card(1)
