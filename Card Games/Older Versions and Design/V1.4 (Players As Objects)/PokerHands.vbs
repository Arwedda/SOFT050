    ...
    Sub DealHCs()
        Do While Human.sCard(0) = Human.sCard(1)
            PickCards Human.sCard, 0, 1
        Loop
	    RemoveFromDeck Human.sCard, 0, 1
        Do While Comp1.sCard(0) = Comp1.sCard(1) Or Comp1sCard(0) = "" Or Comp1.sCard(1) = ""
